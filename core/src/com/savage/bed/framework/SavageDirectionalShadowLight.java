...
public class SavageDirectionalShadowLight extends DirectionalLight implements ShadowMap, Disposable {
	...
	public SavageDirectionalShadowLight (int shadowMapWidth, int shadowMapHeight, float shadowViewportWidth, float shadowViewportHeight,
